...
### Fetching character streams

This library provides the [`CharacterFetcher`][CharacterFetcher] which features three main functionalities to handle character streams:
