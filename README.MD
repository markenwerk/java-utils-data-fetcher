...
This library is hosted in the [Maven Central Repositoy](http://search.maven.org/#artifactdetails|net.markenwerk|utils-data-fetcher|1.1.1|jar). You can use it with the following coordinates:
...
Consult the [usage description](#usage) and [Javadoc](http://markenwerk.github.io/java-utils-data-fetcher/javadoc/1.1.1/index.html) for further information.
...
[Fetcher]: http://markenwerk.github.io/java-utils-data-fetcher/javadoc/1.1.1/index.html?net/markenwerk/utils/data/fetcher/Fetcher.html
