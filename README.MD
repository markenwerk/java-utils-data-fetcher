...
This library is hosted in the [Maven Central Repository](http://search.maven.org/#artifactdetails|net.markenwerk|utils-data-fetcher|2.1.1|jar). You can use it with the following coordinates:
